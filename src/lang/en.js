export default {
    ...
    config:{
        button:{
            enter:'Enter',
            clear:'Clear address',
            notice1:'This app will not connect with other servers except your kong admin api. Your kong admin api address is saved in your browser\'s localstorage, so it\'s safer to manage your kong.',
            notice2:'All requests to the Kong admin api are sent by your browser, so make sure your device can access the Kong admin api without any security auth.',
        ...
        error:{
            ...
            versionNotSupport:'Version {version} is not supported, We only support 0.14.0 and higher',
